...
Use only capabilities you are confident the runtime may support.
...
class LLMClient:
    ...
    def generate(self, objective: str) -> dict[str, Any]:
        ...
        if provider == "stub":
            return {
                ...
                "text": f"Aibo received the objective and prepared it for execution: {objective}",
            }
    ...
    def plan(self, objective: str) -> dict[str, Any]:
        ...
        text = self._request(PLANNER_PROMPT, objective)
        try:
