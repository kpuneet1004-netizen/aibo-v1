...
for _agent in (
    ...
    AgentDefinition(
        ...
        capabilities=["design", "image_generation", "design_review", "execute"],
    ),
    AgentDefinition(
        name="social",
        description="Plans and prepares social media content.",
        capabilities=["content", "caption", "hashtags", "social_planning", "execute"],
    ),
    AgentDefinition(
        name="mockup",
        description="Creates approved apparel product mockups.",
        capabilities=["mockup", "ecommerce", "product_assets", "execute"],
    ),
):
