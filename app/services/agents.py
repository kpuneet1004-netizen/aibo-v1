...
for _agent in (
    AgentDefinition(name="general", description="General Aibo reasoning, web retrieval, and response agent.", capabilities=["respond", "execute", "fetch_url", "summarize_text"]),
